package com.qslib.customview.datetime;
...
import com.qslib.customview.numberpicker.ExtNumberPicker;
import com.qslib.customview.textview.ExtTextView;
import com.qslib.fragment.ExtBaseBottomDialogFragment;
import com.qslib.library.R;
import com.qslib.logger.Logger;
import com.qslib.util.DateTimeUtils;
...
public class ExtDayMonthYearHourMinuteDialogFragment extends ExtBaseBottomDialogFragment {
    ...
    void setUpViews(View view) {
        try {
            ...
            numPickerHour = (ExtNumberPicker) view.findViewById(R.id.numPickerHour);
            numPickerMinute = (ExtNumberPicker) view.findViewById(R.id.numPickerMinute);
        } catch (Exception e) {
            Logger.e(TAG, e);
        }
    }
